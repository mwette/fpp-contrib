...
module_mem_seq: mod_mem ;
module_mem_seq: include_spec ;
...
const_defn: CONSTANT ident '=' expr code_anno ;
abs_type_defn: TYPE ident ;
abs_type_defn: TYPE ident code_anno ;
array_defn: ARRAY ident '=' index ident ;
array_defn: ARRAY ident '=' index ident code_anno ;
enum_defn: enum_defn_4 ;
...
enum_defn_4: enum_defn_3 ;
enum_defn_4: enum_defn_3 code_anno ;
enum_mem_seq: %empty ;
enum_mem_seq: enum_mem ;
enum_mem_seq: enum_mem elt_sep enum_mem_seq ;
enum_mem: ident ;
enum_mem: ident code_anno ;
enum_mem: ident '=' expr ;
enum_mem: ident '=' expr code_anno ;
struct_defn: struct_defn_2 ;
struct_defn_0: STRUCT ident '{' struct_mem_seq '}' ;
struct_defn_1: struct_defn_0 ;
struct_defn_1: struct_defn_0 DEFAULT expr ;
struct_defn_2: struct_defn_1 ;
struct_defn_2: struct_defn_1 code_anno ;
struct_mem_seq: %empty ;
struct_mem_seq: struct_mem ;
struct_mem_seq: struct_mem mem_sep struct_mem_seq ;
struct_mem: struct_mem_3 ;
struct_mem: struct_mem_3 code_anno ;
struct_mem_0: ident ':' ;
...
port_defn_3: port_defn_2 ;
port_defn_3: port_defn_2 code_anno ;
...
spc_port_inst_0: spc_iport_kind PORT ident ;
spc_port_inst_0: spc_oport_kind PORT ident ;
...
spc_iport_kind: COMMAND REG ;
spc_iport_kind: COMMAND RESP ;
spc_iport_kind: EVENT ;
spc_iport_kind: PARAM GET ;
spc_iport_kind: PARAM SET ;
spc_iport_kind: PRODUCT GET ;
spc_iport_kind: PRODUCT REQUEST ;
spc_iport_kind: PRODUCT SEND ;
spc_iport_kind: TELEMETRY ;
spc_iport_kind: TEXT EVENT ;
spc_iport_kind: TIME GET ;
spc_oport_kind: COMMAND RECV ;
spc_oport_kind: PRODUCT RECV ;
...
topo_mem_seq: %empty ;
topo_mem_seq: topo_mem ;
topo_mem_seq: include_spec ;
...
tlm_pktgrp_mem_seq: tlm_pkt_spec ;
tlm_pktgrp_mem_seq: include_spec ;
...
struct_elt_seq: struct_elt ;
struct_elt_seq: struct_elt elt_sep struct_elt_seq ;
struct_elt: ident '=' expr ;
number: _float ;
number: _fixed ;
ident: _ident ;
string: _string ;
...
stmach_inst: stmach_inst_2 code_anno ;
...
state_defn_mem_seq: state_defn_mem ;
